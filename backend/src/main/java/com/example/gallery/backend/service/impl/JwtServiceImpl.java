package com.example.gallery.backend.service.impl;
...
public class JwtServiceImpl implements JwtService {
    ...
    private String secretKey = "asdfdsf3r543#jgk^^%jnkjnhkals303T@#s#$@$34sdf4fjkjuy64.,dfasdfjkhsdkfajhasldkfjafl!@#&&$$#$DFASF";
